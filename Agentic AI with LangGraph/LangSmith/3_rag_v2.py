...
os.environ["LANGCHAIN_PROJECT"]="RAG CHATBOT WITH TRACEABLES"

PDF_PATH = "/Users/prathamsharma/Desktop/AI/LangSmith/islr.pdf"

# ---------- traced setup steps ----------
@traceable(name="load_pdf") # with every traceable u can also add their own metadata and tags
